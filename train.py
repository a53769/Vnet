...
nodule_masks = "E:\data\subset_seg" #"seg-lungs-LUNA16"
lung_masks =   "E:\data\subset_seg"   #"seg-lungs-LUNA16"
ct_images =  "E:\data\subset" #"normalization"
ct_targets = nodule_masks
target_split = [1, 4, 4]
...
#先不进行推理
    ...
    for epoch in range(1, args.nEpochs + 1):
        ...
        save_checkpoint({'epoch': epoch, 'model': model, 'best_prec1': best_prec1}, is_best,
                        args.save, "vnet")
